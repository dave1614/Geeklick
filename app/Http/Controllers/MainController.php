...
class MainController extends Controller
{
    ...
    public function loadTestPage(Request $request){
        ...
        // $url = "https://www.nellobytesystems.com/APIAirtimeV1.asp?UserID=CK100444754&APIKey=DO7XC40T4J08R7LD7YM1KY4748MCA8RD3C6MW12K5H74H28EL3X7R5Y5L938X99J&MobileNetwork=". $mobilenetwork_code ."&Amount=" . $amount . "&MobileNumber=" . $phone_number . "";

        // $url = "https://www.nellobytesystems.com/APIEPINV1.asp?UserID=CK100444754&APIKey=DO7XC40T4J08R7LD7YM1KY4748MCA8RD3C6MW12K5H74H28EL3X7R5Y5L938X99J&MobileNetwork=02&Value=100&Quantity=1";
        // // echo $url;
        // $use_post = true;
        ...
        // return $this->main_model->getUsersFirstMlmDbId(1);
        $sponsor_id = 8;

        $sponsors_sponsor_mlmdb_id = $this->main_model->getMlmDbParamById("sponsor",$sponsor_id);
        $sponsors_sponsor_user_id = $this->main_model->getMlmDbParamById("user_id",$sponsors_sponsor_mlmdb_id);

        return $sponsors_sponsor_user_id;
    ...
    public function viewReceipt (Request $req){
        $user_id = $this->data['user_id'];
        ...
        if($req->get('details')){
            ...
            $props['page_title'] = "Receipt Page";
            $props['details'] = json_decode($details);
            

            return Inertia::render('Receipt',$props);
        }
    }
                ...
                if($validation){
                    ...
                    if($amount_deb_user <= $user_total_amount){
                        ...
                        if($vtu_platform == "payscribe" && $payscribe_disco != ""){
                            ...
                            $url = "https://www.nellobytesystems.com/APIElectricityV1.asp?UserID=CK100444754&APIKey=DO7XC40T4J08R7LD7YM1KY4748MCA8RD3C6MW12K5H74H28EL3X7R5Y5L938X99J&ElectricCompany=" . $club_disco . "&MeterType=" . $club_meter_type . "&MeterNo=" . $meter_no . "&Amount=" . $amount;
                            $use_post = true;
    ...
    public function validateMeterNumberDisco(Request $req){
        ...
        if($validation){
            ...
            // $url = "https://www.nellobytesystems.com/APIVerifyElectricityV1.asp?UserID=CK100444754&APIKey=DO7XC40T4J08R7LD7YM1KY4748MCA8RD3C6MW12K5H74H28EL3X7R5Y5L938X99J&ElectricCompany=".$disco_code."&meterno=".$meter_no;
                            ...
                            if($disco == "eko"){
                                ...
                                if($amount < 1000){
                                    ...
                                    if($vtu_platform == "payscribe" && $payscribe_disco != ""){
                                        ...
                                        // $url = "https://www.payscribe.ng/api/v1/electricity/validate";
                                        $url = "https://www.nellobytesystems.com/APIVerifyElectricityV1.asp?UserID=CK100444754&APIKey=DO7XC40T4J08R7LD7YM1KY4748MCA8RD3C6MW12K5H74H28EL3X7R5Y5L938X99J&ElectricCompany=".$club_disco."&meterno=".$meter_number;
                                        // return $url;
                                        $use_post = true;
                ...
                if($vtu_platform == "payscribe"){ 
                    ...
                    if(is_numeric($package_amount)){
                        ...
                        if($amount_to_debit_user <= $user_total_amount){
                            ...
                            // $url = "https://www.nellobytesystems.com/APICableTVV1.asp?UserID=CK100444754&APIKey=DO7XC40T4J08R7LD7YM1KY4748MCA8RD3C6MW12K5H74H28EL3X7R5Y5L938X99J&CableTV=".$operator."&Package=".$plan."&SmartCardNo=".$decoder_number;

                            $url = "https://www.nellobytesystems.com/APISmileV1.asp?UserID=CK100444754&APIKey=DO7XC40T4J08R7LD7YM1KY4748MCA8RD3C6MW12K5H74H28EL3X7R5Y5L938X99J&MobileNetwork=smile-direct&datatplan=".$plan."&MobileNumber=".$router_number."";
                            // return $url;
                            $use_post = true;
    ...
    public function loadRouterBundlesAndVerifyNumber(Request $req){
        ...
        if($validation){
            ...
            if($vtu_platform == "payscribe"){               
                ...
                if($type == "smile"){
                    $real_type = "smile";
                    $url = "https://www.nellobytesystems.com/APIVerifySmileV1.asp?UserID=CK100444754&APIKey=DO7XC40T4J08R7LD7YM1KY4748MCA8RD3C6MW12K5H74H28EL3X7R5Y5L938X99J&MobileNetwork=smile-direct&MobileNumber=".$router_number;
                }
        ...
        if(isset($post_data->operator) && isset($post_data->decoder_number) && isset($post_data->selected_plan)){
            ...
            if($operator == "dstv" || $operator == "gotv" || $operator == "startimes"){
                ...
                if($vtu_platform == "payscribe"){
                    ...
                    $plan = $selected_plan['package_id'];
                    $url = "https://www.nellobytesystems.com/APIVerifyCableTVV1.0.asp?UserID=CK100444754&APIKey=DO7XC40T4J08R7LD7YM1KY4748MCA8RD3C6MW12K5H74H28EL3X7R5Y5L938X99J&CableTV=".$cable_type."&SmartCardNo=".$decoder_number;
                    // return $url;
                    $use_post = true;
    ...
    public function loadTotalUsersWalletPage (Request $req){
        ...
        $props['active_page'] = 'total_users_wallet';
        $props['page_title'] = $this->main_model->custom_echo('Total Users Wallet',25);

        $props['date_time'] = date("j M Y h:i:sa");
        

        $props['total_amount'] = number_format($this->main_model->getTotalAmountInAllUsersWallets(),2);
        
        return Inertia::render('Admin/TotalUsersWallet',$props);
    ...
    public function transferEarningsToMainAcct(Request $req){
        ...
        $user_id = $this->data['user_id'];
        $mlm_db_id = $this->main_model->getMlmDbIdByUserId($user_id);
        
            
        
        $response_arr = array('success' => false,'not_business' => true,'not_enough_money' => true,'amount' => 0);
        ...
        if($validation){
            ...
            if($amount > 0){
                ...
                $package = $this->main_model->getMlmDbParamById("package",$mlm_db_id);
                if($package == 2){
                    $response_arr['not_business'] = false;
                    $amount_withdrawable = $this->main_model->getTotalWithdrawableMlmIncome($user_id);
                    // return json_encode($amount_withdrawable);
    ...
    public function loadUserEarningsPage (Request $req){
        ...
        $props['total_business_earnings'] = $props['business_sponsor_earnings'] + $props['vtu_trade_income'];
        ...
        $props['grand_total_balance'] = $props['total_withdrawable_business_earnings'] - $props['total_mlm_withdrawn'];
    ...
    public function recieveProvidusWebhooks(Request $req){
        ...
        if(isset($post->sessionId) && isset($post->accountNumber) && isset($post->tranRemarks) && isset($post->transactionAmount) && isset($post->settledAmount) && isset($post->feeAmount) && isset($post->vatAmount) && isset($post->currency) && isset($post->initiationTranRef) && isset($post->settlementId) && isset($post->sourceAccountNumber) && isset($post->sourceAccountName) && isset($post->sourceBankName) && isset($post->channelId) && isset($post->tranDateTime)){
            ...
            if(isset($headers['X-Auth-Signature']) && strtolower($headers['X-Auth-Signature']) == hash("sha512","R0VFS0kgTENL:61C7FFE86689DC86A97A01B9584549F4438EAE1FA041A2D5771620E0541A2514") && $this->main_model->checkIfThisProvidusAccountNumberIsValid($accountNumber) && !$this->main_model->checkIfThisProvidusWebhookIsDuplicate($settlementId)){
            // if(isset($headers['X-Auth-Signature']) && strtolower($headers['X-Auth-Signature']) == "be09bee831cf262226b426e39bd1092af84dc63076d4174fac78a2261f9a3d6e59744983b8326b69cdf2963fe314dfc89635cfa37a40596508dd6eaab09402c7" && $this->main_model->checkIfThisProvidusAccountNumberIsValid($accountNumber) && !$this->main_model->checkIfThisProvidusWebhookIsDuplicate($settlementId)){
                $response_arr = array(
                ...
                if($transactionAmount >= 1 && $transactionAmount <= 9990){
                    $amount_to_credit = $transactionAmount - 20;
                }else if($transactionAmount >= 9991){
    ...
    public function purchaseClubKonnectData(Request $req){
        ...
        if($validation){
            ...
            if(isset($post_data->selected_plan['product_id'])){
                ...
                //         $url = "https://www.nellobytesystems.com/APIDatabundleV1.asp?UserID=CK100444754&APIKey=DO7XC40T4J08R7LD7YM1KY4748MCA8RD3C6MW12K5H74H28EL3X7R5Y5L938X99J&MobileNetwork=".$mobilenetwork_code."&DataPlan=".$product_id."&MobileNumber=".$phone_number;
                //         $use_post = true;
    ...
    public function generateEpin(Request $req){
        ...
        if($validation){
            ...
            if($amount_to_debit_user <= $user_total_amount){
                ...
                $url = "https://www.nellobytesystems.com/APIEPINV1.asp?UserID=CK100444754&APIKey=DO7XC40T4J08R7LD7YM1KY4748MCA8RD3C6MW12K5H74H28EL3X7R5Y5L938X99J&MobileNetwork=".$club_network."&Value=".$amount."&Quantity=".$quantity;
    ...
    public function normalAirtimeRechargeRequest(Request $req){
        ...
        if($validation){
            ...
            if($amount <= $user_total_amount){
                ...
                // $url = "https://www.nellobytesystems.com/APIServerIPV1.asp?UserID=CK100444754&APIKey=DO7XC40T4J08R7LD7YM1KY4748MCA8RD3C6MW12K5H74H28EL3X7R5Y5L938X99J";
                    ...
                    if($response->status){
                        ...
                        if($transaction_status == "refunded"){
                         if($refunded_status == 0){
                             ...
                             $commision_amount = $this->main_model->getCommissionAmountPaidToUser($type,$amount_paid);
                             $amt_To_refund = $amount_paid - $commision_amount;
                             $summary = "VTU Transaction Refund For ORDER ID: ". $order_id;
                             if($this->main_model->creditUser($user_id,$amt_To_refund,$summary)){
                                 $form_array = array(
                                     "refunded" => 1
                                 );
                                 $this->main_model->updateVtuTable($form_array,$table_id);
                             }
                         }
                        }
    ...
    public function trackClubVtuOrder(Request $req){
        ...
        if(isset($post_data->show_records) && isset($post_data->order_id)){
            ...
            $url = "https://www.nellobytesystems.com/APIQueryV1.asp?UserID=CK100444754&APIKey=DO7XC40T4J08R7LD7YM1KY4748MCA8RD3C6MW12K5H74H28EL3X7R5Y5L938X99J&OrderID=".$order_id;
            $use_post = true;
        ...
        if(isset($post_data->user_id)){
            ...
            if($validation){
                ...
                if($this->main_model->creditUser($user_id,$amount,$summary)){
                    ...
                    if($this->main_model->debitUser($user_id,$charge,"Admin Credit Charge")){
        ...
        if($this->main_model->checkIfUserHasHalfRegisteredBySlug($user_slug) && $this->main_model->getUserNameBySlug($user_slug)){
            ...
            if(is_object($user_info)){
                foreach($user_info as $user){
                    ...
                    $this->data['balance'] = 0 - $registration_amt_paid;
                    ...
                    if($type == "mtn"){
                        ...
                        if($sub_type == "clubkonnect"){
                            ...
                            if($amount_to_debit_user <= $user_total_amount){
                                ...
                                $url = "https://www.nellobytesystems.com/APIDatabundleV1.asp?UserID=CK100444754&APIKey=DO7XC40T4J08R7LD7YM1KY4748MCA8RD3C6MW12K5H74H28EL3X7R5Y5L938X99J&MobileNetwork=".$mobilenetwork_code."&DataPlan=".$product_id."&MobileNumber=".$mobile_no;
                                $use_post = true;
                ...
                if(Support_Request::validate([
                    ...
                    if($amount_to_debit_user <= $user_total_amount){
                        ...
                        if(!isset($post_data->combo)){
                            ...
                            $url = "https://www.nellobytesystems.com/APIAirtimeV1.asp?UserID=CK100444754&APIKey=DO7XC40T4J08R7LD7YM1KY4748MCA8RD3C6MW12K5H74H28EL3X7R5Y5L938X99J&MobileNetwork=". $mobilenetwork_code ."&Amount=" . $amount . "&MobileNumber=" . $mobile_no;
                            // return $url;
