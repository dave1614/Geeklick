...
Route::group(['middleware'=>['protectedPages']],function(){
    ...
    Route::get('/receipt',[MainController::class,'viewReceipt'])->name('receipt_page');
    ...
    Route::group(['middleware'=>['protectedAdminPages']],function(){
        ...
        Route::get('/total_users_wallet',[MainController::class,'loadTotalUsersWalletPage'])->name('total_users_wallet');
