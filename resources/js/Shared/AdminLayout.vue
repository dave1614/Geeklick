      ...
      <div class="sidebar-wrapper">
          ...
          <ul class="nav">
            ...
            <li :class="$page.props.active_page == 'view_admin_vtu_earnings' || $page.props.active_page == 'airtime_combo_requests' || $page.props.active_page == 'data_combo_requests' || $page.props.active_page == 'account_credit_history' || $page.props.active_page == 'admin_account_credit_history' || $page.props.active_page == 'account_debit_history' || $page.props.active_page == 'product_advance_history' || $page.props.active_page == 'view_advance_loan_history' ? 'nav-item active' : 'nav-item' ">
              ...
              <div id="reports-nav-link" :class="$page.props.active_page == 'total_users_wallet' || $page.props.active_page == 'view_admin_vtu_earnings' || $page.props.active_page == 'airtime_combo_requests' || $page.props.active_page == 'data_combo_requests' || $page.props.active_page == 'account_credit_history' || $page.props.active_page == 'admin_account_credit_history' || $page.props.active_page == 'account_debit_history' || $page.props.active_page == 'product_advance_history' || $page.props.active_page == 'view_advance_loan_history'  ? 'collapse show' : 'collapse' ">
                <ul class="nav">

                  <li :class="$page.props.active_page == 'total_users_wallet' ? 'nav-item active' : 'nav-item' ">
                      
                      <inertia-link class="nav-link" :href="route('total_users_wallet')">
                          <span class="sidebar-mini"> TW</span>
                          <p> Total Users Wallet</p>
                      </inertia-link>
                  </li>
