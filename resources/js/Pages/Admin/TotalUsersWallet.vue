      ...
      <div class="">
        <div class="container-fluid">
          ...
          <div class="row justify-content-center" style="">
            ...
            <div class="card">
              <div class="card-body">
                <h3 v-html="'Total Amount In Members Wallet As Of ' + date_time" style="font-weight: bold;" class="text-center"></h3>
                <h5><b>Amount: </b> <em class="text-primary" v-html="'₦' + total_amount"></em></h5>
