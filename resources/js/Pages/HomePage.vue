        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-12 card">
              <div class="card-body" v-if="user_info.providus_account_number != null && user_info.providus_account_name != null">
                ...
                <h6>Providus Bank</h6>
                <p class="text-bold">
                  <span>From ₦1 to ₦9,990 attracts ₦20 charge</span><br>
                  <span>₦9,991 or greater attracts ₦70 charge</span>
                </p>
                <tr>
                  <td></td>
            ...
            <div class="col-md-6">
              <div class="row justify-content-center">
                <a href="https://chat.whatsapp.com/FC1xMCz5OZ69z3FcZD48hH" class="btn btn-success btn-round" target="_blank" ><i style="font-size:17px;" class="fab fa-whatsapp"></i></i>&nbsp;&nbsp;&nbsp;&nbsp;Join our WhatsApp Group</a>
              </div>
            </div>
          ...
          <!-- <div class="">
            ...
            <div class="card">
              <div class="card-body">
                <ul class="list-group">
                  <li class="list-group-item d-flex justify-content-between align-items-center text-bold p-0">
                    <inertia-link class="nav-link" :href="route('airtime_page')">
                    Airtime Topup
                  </inertia-link>
                    <span class="badge badge-primary badge-pill">AT</span>
                  </li>
                  ...
                  <li class="list-group-item d-flex justify-content-between align-items-center text-bold p-0">
                    ...
                    <span class="badge badge-primary badge-pill">CT</span>
                  </li>
                  ...
                  <li class="list-group-item d-flex justify-content-between align-items-center text-bold p-0">
                    ...
                    <span class="badge badge-primary badge-pill">ET</span>
                  </li>
                  ...
                  <li class="list-group-item d-flex justify-content-between align-items-center text-bold p-0">
                    ...
                    <span class="badge badge-primary badge-pill">AW</span>
                  </li>
                  ...
                  <li class="list-group-item d-flex justify-content-between align-items-center text-bold p-0">
                    ...
                    <span class="badge badge-primary badge-pill">BS</span>
                  </li>
                  ...
                  <li class="list-group-item d-flex justify-content-between align-items-center text-bold p-0">
                    ...
                    <span class="badge badge-primary badge-pill">RR</span>
                  </li>
                  ...
                  <li class="list-group-item d-flex justify-content-between align-items-center text-bold p-0">
                    ...
                    <span class="badge badge-primary badge-pill">EV</span>
                  </li>
                  ...
                  <li class="list-group-item d-flex justify-content-between align-items-center text-bold p-0">
                    ...
                    <span class="badge badge-primary badge-pill">SBL</span>
                  </li>
                  ...
                  <li class="list-group-item d-flex justify-content-between align-items-center text-bold p-0">
                    ...
                    <span class="badge badge-primary badge-pill">BLH</span>
                  </li>
                  ...
                  <li class="list-group-item d-flex justify-content-between align-items-center text-bold p-0">
                    ...
                    <span class="badge badge-primary badge-pill">H</span>
                  </li>
                  ...
                  <li class="list-group-item d-flex justify-content-between align-items-center text-bold p-0">
                    ...
                    <span class="badge badge-primary badge-pill">EC</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-sm-3 col-5 offset-1 card">
                <div class="card-body p-0">
                  <img class="col-12 p-0" src="/images/airtime.jpg" alt="Airtime image">
                  <div class="" style="position: relative;">
                    <h4 class="text-bold pt-2 text-center" style="position: abosolute; bottom: 0;">Airtime</h4>
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-3 col-5 offset-1 card">
                <div class="card-body p-0">
                  <img class="col-12 p-0" src="/images/data_plans.jpg" alt="Internet Data image">
                  <div class="" style="position: relative;">
                    <h4 class="text-bold pt-2 text-center" style="position: abosolute; bottom: 0;">Data</h4>
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-3 col-5 offset-1 card">
                <div class="card-body p-0">
                  <img class="col-12 p-0" src="/images/cable_tv.jpg" alt="Cable Tv image">
                  <div class="" style="position: relative;">
                    <h4 class="text-bold pt-2 text-center" style="position: abosolute; bottom: 0;">Cables</h4>
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-3 col-5 offset-1 card">
                <div class="card-body p-0">
                  <img class="col-12 p-0" src="/images/electricity.jpg" alt="Electricity Topup image">
                  <div class="" style="position: relative;">
                    <h4 class="text-bold pt-2 text-center" style="position: abosolute; bottom: 0;">Electricity</h4>
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-3 col-5 offset-1 card">
                <div class="card-body p-0">
                  <img class="col-12 p-0" src="/images/airtocash.png" alt="Airtime To Wallet image">
                  <div class="" style="position: relative;">
                    <h4 class="text-bold pt-2 text-center" style="position: abosolute; bottom: 0;">Airtime To Wallet</h4>
                  </div>
                </div>
              </div>
              ...
              <!-- <div class="col-sm-3 col-5 offset-1 card">
                <div class="card-body p-0">
                  <img class="col-12 p-0" src="/images/bulk_sms.png" alt="Bulk SMS image">
                  <div class="" style="position: relative;">
                    <h4 class="text-bold pt-2 text-center" style="position: abosolute; bottom: 0;">Bulk SMS</h4>
                  </div>
                </div>
              </div>
 -->
              <div class="col-sm-3 col-5 offset-1 card">
                <div class="card-body p-0">
                  <img class="col-12 p-0" src="/images/router.jpg" alt="Router Recharge image">
                  <div class="" style="position: relative;">
                    <h4 class="text-bold pt-2 text-center" style="position: abosolute; bottom: 0;">Router Recharge</h4>
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-3 col-5 offset-1 card">
                <div class="card-body p-0">
                  <img class="col-12 p-0" src="/images/educational.webp" alt="Educational Vouchers image">
                  <div class="" style="position: relative;">
                    <h4 class="text-bold pt-2 text-center" style="position: abosolute; bottom: 0;">Educational Vouchers</h4>
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-3 col-5 offset-1 card">
                <div class="card-body p-0">
                  <img class="col-12 p-0" src="/images/pos.jpg" alt="Pos Machine image">
                  <div class="" style="position: relative;">
                    <h4 class="text-bold pt-2 text-center" style="position: abosolute; bottom: 0;">Pos Machine Purchase</h4>
                  </div>
                </div>
              </div>
              ...
              <!-- <div class="col-sm-3 col-5 offset-1 card">
                <div class="card-body p-0">
                  <img class="col-12 p-0" src="/images/business_loan.jpg" alt="Smart Business Loan image">
                  <div class="" style="position: relative;">
                    <h4 class="text-bold pt-2 text-center" style="position: abosolute; bottom: 0;">Smart Business Loan</h4>
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-3 col-5 offset-1 card">
                <div class="card-body p-0">
                  <img class="col-12 p-0" src="/images/history.webp" alt="Smart Business Loan History image">
                  <div class="" style="position: relative;">
                    <h4 class="text-bold pt-2 text-center" style="position: abosolute; bottom: 0;">Smart Business Loan History</h4>
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-3 col-5 offset-1 card">
                <div class="card-body p-0">
                  <img class="col-12 p-0" src="/images/health.png" alt="Health image">
                  <div class="" style="position: relative;">
                    <h4 class="text-bold pt-2 text-center" style="position: abosolute; bottom: 0;">Health</h4>
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-3 col-5 offset-1 card">
                <div class="card-body p-0">
                  <img class="col-12 p-0" src="/images/e_commerce.jpg" alt="E-Commerce image">
                  <h4 class="text-bold pt-2 text-center">E-Commerce</h4>
                </div>
              </div> -->
            </div>
          </div>
