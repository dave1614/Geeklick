      ...
      <div class="">
        <div class="container-fluid">
          <div class="text-right">
            ...
            <a href="https://wa.me/2348060505093?text=I Have A Problem With My Router Recharge" class="btn btn-success" target="_blank" ><i style="font-size:17px;" class="fab fa-whatsapp"></i></i>&nbsp;&nbsp;&nbsp;&nbsp;Support</a>
          </div>
      ...
      self.buy_router_request.post(self.route('recharge_router'), {
        ...
        onSuccess: (page) => {
          ...
          if(response.success){
            ...
            swal({
              title: 'Success',
              text: "You Have Successfully Recharged Your " + router_service + " Router <em class='text-primary'>" + router_number + "</em> With " + self.buy_router_request.selected_plan.name + " Which Costs ₦" + self.addCommas(self.buy_router_request.selected_plan.amount) +" <p><em>You Have Been Debited Of ₦" + self.addCommas(self.buy_router_request.selected_plan.amount) + "</em></p>. Do You Want To View Receipt?" ,
              type: 'success',
              ...
              var arr = [
                ...
                {
                  'key' : 'Amount',
                  'value' :  '₦' + self.addCommas(self.buy_router_request.selected_plan.amount),
                },
                {
                  'key' : 'Router Number',
                  'value' : router_number,
                ...
                {
                  'key' : 'Selected Plan',
                  'value' : self.buy_router_request.selected_plan.name,
                },
                {
                  'key' : 'Selected Plan Validity',
                  'value' : self.buy_router_request.selected_plan.validity,
                },
