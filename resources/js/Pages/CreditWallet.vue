              ...
              <div class="card" id="main-card">
                ...
                <div class="card-body">
                  <div class="" v-if="providus_account_number != null && providus_account_name != null">
                    ...
                    <p class="text-center">From ₦1 to ₦9,990 attracts ₦20 charge</p>
                    <p class="text-center">₦9,991 or greater attracts ₦70 charge</p>
                  ...
                  <!-- <p class="text-center">Deposit To Nkechi Peace Ukworu: </p>
                  ...
                  <table class="table">
                    <tbody>
                      <tr>
                       ...
                       <tr>
                        <td>A/c No</td>
                        <td><em class="text-primary">2083292022</em></td>
                      </tr>
                  ...
                  <p class="text-center">Deposit To Geeklickservices: </p>
                  ...
                  <table class="table">
                    <tbody>
                      <tr>
                       ...
                       <tr>
                        <td>A/c No</td>
                        <td><em class="text-primary">5401232236 </em></td>
                      </tr>
