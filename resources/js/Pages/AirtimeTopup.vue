      ...
      <div class="">
        <div class="container-fluid">
          <div class="text-right">
            ...
            <a href="https://wa.me/2348060505093?text=I Have A Problem With My Airtime Recharge&" class="btn btn-success" target="_blank" ><i style="font-size:17px;" class="fab fa-whatsapp"></i></i>&nbsp;&nbsp;&nbsp;&nbsp;Support</a>
          </div>
      ...
      self.buy_airtime_request.post(self.route('normal_airtime_recharge_request'), {
        ...
        onSuccess: (page) => {
          ...
          if(response.success && response.order_id !== ""){
            ...
            swal({
              title: 'Info',
              text: "You Have Successfully Credited <em class='text-primary'>" + phone_number + "</em> With Airtime Worth ₦" + self.addCommas(amount) + " On <span style='text-transform: capitalize;'>" + network + "</span> Network. Note You Have Been Debited Of ₦" + self.addCommas(amount)  + ". The Order Id For This Transaction Is <em class='text-primary'>" +order_id + "</em>. Do You Want To View Receipt?",
              type: 'info',
