...
<template>
    <div class="content">
      ...
      <div class="">
        <div class="container-fluid">
          <div class="text-right">
            ...
            <a href="https://wa.me/2348060505093?text=I Have A Problem With My Internet Data Recharge&" class="btn btn-success" target="_blank" ><i style="font-size:17px;" class="fab fa-whatsapp"></i></i>&nbsp;&nbsp;&nbsp;&nbsp;Support</a>
          </div>
      ...
      <div @click="validateBuyDataRequest" v-if="!buy_data_request.processing">
        <floating-text-button :styles="'background: #5E2C04;'" :title="'Proceed'">
      ...
      self.buy_data_request.post(self.route('purchase_eminence_data'), {
        ...
        onSuccess: (page) => {
          ...
          if(response.success){
            ...
            text_html += " Do You Want To View Receipt?"
      ...
      self.buy_data_request.post(self.route('purchase_9mobile_combo_data'), {
        ...
        onSuccess: (page) => {
          ...
          if(response.success){
            ...
            var text_html = "Your SME DATA Recharge Request To Credit <em class='text-primary'>" + phone_number + "</em> With Data Worth " + product_name + " On <span style='text-transform: capitalize;'>" + network + "</span> Network Has Been Sent To The Admin. You Would Be Credited Shortly . Note You Have Been Debited Of ₦" + self.addCommas(amount)  + ". Do You Want To View Receipt?"
