		...
		<div class="container-login100">
			...
			<div class="wrap-login100">
				<div class="text-center" style="width: 100%;">
					<img src="{{ asset('/images/geeklick_logo.jpeg?v=1.3') }}" style="width: 150px; height: 150px; border-radius: 50%;">
				</div>
				...
				?>
					...
					<div class="text-center p-t-30 create-account">
						<a class="txt2 text-bold" href="#" style="font-size: 16px; font-weight: bold;">
							Create Your Account
		...
		$(document).ready(function () {
			...
			$(".create-account").click(function (evt) {
				...
				swal({
		    		...
		    		console.log(result)
			      	if (result.value) {
			   //    		$("#sign-up-form #sponsor_user_name").val("admin");
			   //    		$("#sign-up-form #sponsor_user_name").trigger("focusout");
			   //    		$("#sign-up-form").on("focusout", "#sponsor_user_name", function() {
						//     console.log("focusout happened!");
						// });
			      		// $("#sign-up-form #sponsor_user_name").focus();
			      		$("#login-form").toggle();
						$("#sign-up-form").toggle();
						window.scrollTo(0,0);
