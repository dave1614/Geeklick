...
<html>
<head>
  <title>Geeklick Services | GKS</title>
  <meta charset="utf-8" />
  <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('/images/geeklick_logo.jpeg') }}">
  <link rel="icon" type="image/png" href="{{ asset('/images/geeklick_logo.jpeg') }}">
...
<link href="https://fonts.googleapis.com/css2?family=Raleway:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap" rel="stylesheet">
...
<body class="animated fadeInLeft">
  <nav class="navbar navbar-expand-lg navbar-light static-top mb-5 shadow animated bounceInDown" style="background-color: transparent;">
    <div class="container">
      <a class="navbar-brand" href="#"><img src="{{ asset('/images/geeklick_logo.jpeg') }}" style="width: 50px; height: 50px; border-radius: 50%;" alt=""></a>
...
<!-- Page Content -->
  <div class="container">
    <div class="card border-0 shadow my-5" style="background: transparent;">
      <div class="card-body p-5" style="margin-top: 56px;">
        <h1 class="font-weight-light animated fadeInLeft head text-bold" style="font-style: italic;">Geeklick Services</h1>
        <p class="animated fadeInLeft text-bold " style="font-size: 18px; font-style: italic;">Just a Click with GEEKLICK!</p>
    ...
    <section id="about-us" style="margin-top: 100px;">
      ...
      <div class="card border-0 shadow my-5" style="background: transparent;">
        <div class="card-body p-5">
          <p class="lead animated fadeInLeft section-text"> Geekclick Services is a Great Platform mainly for SMEs and the general public at large....because it's highly cost effective. This is where you gets the Cheapest Data in the Country - Data which is moreorless the life blood of the current day businesses, and still gets 3% of the volume purchased
          as Cash Back. <a href="#" onclick="showMoreAboutUs(this,event)">Read More</a></p>

          <p class="lead animated fadeInLeft section-text" style="display: none;"> 

            Geekclick Services is a Great Platform mainly for SMEs and the general public at large....because it's highly cost effective. This is where you gets the Cheapest Data in the Country - Data which is moreorless the life blood of the current day businesses, and still gets 3% of the volume purchased
            as Cash Back. <br> <br>

            You also buys Airtime,  Cable Subscriptions, NEPA Bill Payments, Genuine Airtime to Cash Conversation, Bulk SMS, POS machine purchase, etc. All at the Comfort of your Zone .....with just a Click with GEEKLICK SERVICES.<a href="#" onclick="showLessAboutUs(this,event)">Read Less</a></p>
        </div>
      </div>
      ...
      <div class="card border-0 shadow my-5" style="background: transparent;">
        <div class="card-body p-5">
          <h4 class="text-bold text-center mb-5">Compensation Plan (Cash Back)</h4>
          <div class="row">
            <div class="col-6">
              <b>Data</b>
            </div>
          ...
          <h4 class="text-bold text-center mt-5">Fund Withdrawals</h4>

          <div class="pt-2">
            <p>Registration is Free....but to start withdrawing your Bonuses ....you have to Upgrade to Diamond Class.. with just ₦500</p>
          </div>
          <div class="pt-2">
            ₦200 goes to your Sponsor <br>
            ₦100 goes to the sponsor of your sponsor <br>
            ₦200 goes back to Admin ..for Effective and Efficient day to day Running of the Business
          </div>
        </div>
      </div>
            ...
            <div class="row">
              <div class="card border-0 shadow my-5 col-sm-3" id="vtu-card" style="padding: 0;">
                <div class="card-body" style="padding: 0;">
                  ...
                  <h3 class="text-center" style="text-transform: uppercase; margin-top: 10px; color: #000;">Data</h3>
              ...
              <div class="card border-0 shadow my-5 col-sm-3 offset-sm-1" id="import-card" style="padding: 0;">
                <div class="card-body" style="padding: 0;">
                  <img src="{{ asset('/images/data_plans.jpg') }}" style="padding: 0; height: 200px;" class="col-12" alt="">
                  <h3 class="text-center" style="text-transform: uppercase; margin-top: 10px; color: #000;">Airtime (VTU & Recharge Card Epins)</h3>
                  <div class="card-body-lower" style="padding: 10px;">
                    <p style="color: #000;  display: none;">
              ...
              <div class="card border-0 shadow my-5 col-sm-3 offset-sm-1" id="health-card" style="padding: 0;">
                <div class="card-body" style="padding: 0;">
                  <img src="{{ asset('/images/cable_tv.jpg') }}" style="padding: 0; height: 200px;" class="col-12" alt="">
                  <h3 class="text-center" style="text-transform: uppercase; margin-top: 10px; color: #000;">Cable Subscriptions</h3>
                  <div class="card-body-lower" style="padding: 10px;">
                    <p style="color: #000;  display: none;">
              ...
              <div class="card border-0 shadow my-5 col-sm-3" id="e-commerce-card" style="padding: 0; ">
                <div class="card-body" style="padding: 0;">
                  <img src="{{ asset('/images/electricity.jpg') }}" style="padding: 0; height: 200px;" class="col-12" alt="">
                  <h3 class="text-center" style="text-transform: uppercase; margin-top: 10px; color: #000;">NEPA Bill Payments</h3>
                  <div class="card-body-lower" style="padding: 10px;">
                    <p style="color: #000;  display: none;">
                    E-Business <br> <br>
              ...
              <div class="card border-0 shadow my-5 col-sm-3 offset-sm-1" id="compensation-card" style="padding: 0;">
                <div class="card-body" style="padding: 0;">
                  <img src="{{ asset('/images/bulk_sms.png') }}" style="padding: 0; height: 200px;" class="col-12" alt="">
                  <h3 class="text-center" style="text-transform: uppercase; margin-top: 10px; color: #000;">Bulk SMS</h3>
                  <div class="card-body-lower" style="padding: 10px;">
              ...
              <div class="card border-0 shadow my-5 col-sm-3 offset-sm-1" id="love-affairs-card" style="padding: 0;">
                <div class="card-body" style="padding: 0;">
                  <img src="{{ asset('/images/airtocash.png') }}" style="padding: 0; height: 200px;" class="col-12" alt="">
                  <h3 class="text-center" style="text-transform: uppercase; margin-top: 10px; color: #000;">Airtime to Cash Conversation</h3>

                  <div class="card-body-lower" style="padding: 10px;">
                    <p style="color: #000;  display: none;">Our Love, Sex and Relationship Matters page aims to have an open, honest, and non-judgmental attitude towards sex, love and relationship. <a href="#" onclick="readMore(this,event)">Read More</a></p>
              ...
              <div class="card border-0 shadow my-5 col-sm-3 " id="love-affairs-card" style="padding: 0;">
                <div class="card-body" style="padding: 0;">
                  <img src="{{ asset('/images/pos.jpg') }}" style="padding: 0; height: 200px;" class="col-12" alt="">
                  <h3 class="text-center" style="text-transform: uppercase; margin-top: 10px; color: #000;">POS Machine Purchase</h3>
              ...
              <div class="card border-0 shadow my-5 col-sm-3 offset-sm-1" id="love-affairs-card" style="padding: 0;">
                <div class="card-body" style="padding: 0;">
                  <img src="{{ asset('/images/router.jpg') }}" style="padding: 0; height: 200px;" class="col-12" alt="">
                  <h3 class="text-center" style="text-transform: uppercase; margin-top: 10px; color: #000;">Router Subscription</h3>
              ...
              <div class="card border-0 shadow my-5 col-sm-3 offset-sm-1" id="love-affairs-card" style="padding: 0;">
                <div class="card-body" style="padding: 0;">
                  <img src="{{ asset('/images/educational.webp') }}" style="padding: 0; height: 200px;" class="col-12" alt="">
                  <h3 class="text-center" style="text-transform: uppercase; margin-top: 10px; color: #000;">Educational Vouchers</h3>
      ...
      <div class="card border-0 shadow my-5" style="background: transparent;">
        <div class="card-body p-5 row">
          <div class="col-sm-6">
            ...
            <iframe class="col-12" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3963.877023809515!2d3.212405664976335!3d6.5372109709191735!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x103b84e37bfaf7e5%3A0xe9ede1ab5e5df848!2sAfolabi%20Esan%20Cl%2C%20Ikotun%20102213%2C%20Lagos!5e0!3m2!1sen!2sng!4v1653646877072!5m2!1sen!2sng" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
          </div>
          ...
          <div class="col-sm-6">
            ...
            <a href="#">
              <div class="row mt-5">
                ...
                <div class="col-2 text-right" style="padding: 0;">
                  <i class="fas fa-map-marker-alt" style="font-size: 21px; color: white;"></i> 

                </div>

                <div class="col-10" style="color: white;">
                  NO8B AFOLABI ESAN CLOSE, ADEXON ILEKPO BUS STOP, AKESAN LAGOS <br>
                </div>
            ...
            <a target="_blank" href="https://wa.me/2348095812402">
              <div class="row" style="margin-top: 13px">
              
                <div class="col-2 text-right" style="padding: 0;">
                  <i class="fab fa-whatsapp" style="font-size: 21px; color: white;"></i> 
                </div>

                <div class="col-10" style="color: white;">
                  08095812402,  08060505093
                  {{-- <div class="col-12">
                    <a href="#" style="color: white;">08095812402</a>,
                    <a href="#" style="color: white;">08060505093</a>
                  </div> --}}
                </div>
 ...
 --}}
            ...
            <a target="_blank" href="tel:+08095812402 ">
              <div class="row" style="margin-top: 13px">
            ...
            <a target="_blank" href="mailto: geeklickservices@gmail.com">
              <div class="row" style="margin-top: 13px">
